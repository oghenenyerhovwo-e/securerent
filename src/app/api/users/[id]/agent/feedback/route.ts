...
export const PUT = async (request: NextRequest, { params }: { params: {id: string }}) => {    
    try {
        ...
        foundProfile.agentApplicationFeedback = data.agentApplicationFeedback || foundProfile.agentApplicationFeedback
        foundProfile.agentApplicationStatus = data.agentApplicationStatus || foundProfile.agentApplicationStatus
